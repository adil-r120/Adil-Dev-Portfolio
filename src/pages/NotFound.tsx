...
const NotFound = () => {
    return (
        <div className="min-h-screen bg-background flex flex-col">
            ...
            <main className="flex-grow flex items-center justify-center px-4 pt-24 pb-20">
                <div className="text-center space-y-8 animate-fade-in-up">
                    <div className="relative inline-block">
                        <h1 className="text-9xl font-extrabold text-blue-900/10">404</h1>
            ...
            <div className="fixed top-0 right-0 w-[500px] h-[500px] bg-orange-500/5 rounded-full blur-[100px] -z-10"></div>
